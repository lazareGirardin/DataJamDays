...
ASC_KLE = Beta('ASC_KLE', -5.24262, -100, 100, 0, 'ASC_KLE')

BETA_DISTANCE_LUNCH_CAF = Beta('BETA_DISTANCE_LUNCH_CAF', -0.00397432, -100, 100, 0, 'BETA_DISTANCE_LUNCH_CAF')

ALPHA_FIRST_LUNCH_CHOICE = Beta('ALPHA_FIRST_LUNCH_CHOICE', 1.07321, -100, 100, 0, 'ALPHA_FIRST_LUNCH_CHOICE')

ALPHA_FIRST_MORNING_CHOICE = Beta('ALPHA_FIRST_MORNING_CHOICE', 1.45927, -100, 100, 0, 'ALPHA_FIRST_MORNING_CHOICE')
...
RHO_PREVIOUS_MORNING_CHOICE = Beta('RHO_PREVIOUS_MORNING_CHOICE', 0.475902, -100, 100, 0, 'RHO_PREVIOUS_MORNING_CHOICE')

RHO_PREVIOUS_LUNCH_CHOICE = Beta('RHO_PREVIOUS_LUNCH_CHOICE', 0.354988, -100, 100, 0, 'RHO_PREVIOUS_LUNCH_CHOICE')

BETA_DISTANCE_MORNING = Beta('BETA_DISTANCE_MORNING', -0.0039014, -100, 100, 0, 'BETA_DISTANCE_MORNING')

BETA_TAP_BEER_AFTER_LUNCH = Beta('BETA_TAP_BEER_AFTER_LUNCH', 1.13996, -100, 100, 0, 'BETA_TAP_BEER_AFTER_LUNCH')

BETA_DISTANCE_AFTERNOON = Beta('BETA_DISTANCE_AFTERNOON', -0.00106794, -100, 100, 0, 'BETA_DISTANCE_AFTERNOON')

BETA_EVALUATION_CAFET = Beta('BETA_EVALUATION_CAFET', 1.899, -100, 100, 0, 'BETA_EVALUATION_CAFET')

BETA_NO_DISTANCE_AV = Beta('BETA_NO_DISTANCE_AV', -3.66023, -100, 100, 0, 'BETA_NO_DISTANCE_AV')

BETA_DINNER = Beta('BETA_DINNER', 0.795246, -100, 100, 0, 'BETA_DINNER')

BETA_PRICE_STUDENT = Beta('BETA_PRICE_STUDENT', -0.48579, -100, 100, 0, 'BETA_PRICE_STUDENT')

BETA_PRICE_EMPLOYEE = Beta('BETA_PRICE_EMPLOYEE', -0.367854, -100, 100, 0, 'BETA_PRICE_EMPLOYEE')

BETA_METEO_TERRACE = Beta('BETA_METEO_TERRACE', 0, -100, 100, 1, 'BETA_METEO_TERRACE')

BETA_CAPACITY_INSIDE = Beta('BETA_CAPACITY_INSIDE', 0.0119115, -100, 100, 0, 'BETA_CAPACITY_INSIDE')

SIGMA_LUNCH_KLE = Beta('SIGMA_LUNCH_KLE', 2.70704, -100, 100, 0, 'SIGMA_LUNCH_KLE')

SIGMA_MORNING_KLE = Beta('SIGMA_MORNING_KLE', 2.17022, -100, 100, 0, 'SIGMA_MORNING_KLE')

ALPHA_FREQUENCY_LUNCH = Beta('ALPHA_FREQUENCY_LUNCH', 0.618144, -100, 100, 0, 'ALPHA_FREQUENCY_LUNCH')

ALPHA_FREQUENCY_MORNING = Beta('ALPHA_FREQUENCY_MORNING', 0.449542, -100, 100, 0, 'ALPHA_FREQUENCY_MORNING')

ASC_BC = Beta('ASC_BC', -0.682184, -100, 100, 0, 'ASC_BC')

BETA_DISTANCE_LUNCH_SELF = Beta('BETA_DISTANCE_LUNCH_SELF', -0.00399651, -100, 100, 0, 'BETA_DISTANCE_LUNCH_SELF')

BETA_EVALUATION_SELF = Beta('BETA_EVALUATION_SELF', 2.01605, -100, 100, 0, 'BETA_EVALUATION_SELF')

SIGMA_LUNCH_BC = Beta('SIGMA_LUNCH_BC', -2.19567, -100, 100, 0, 'SIGMA_LUNCH_BC')

SIGMA_MORNING_BC = Beta('SIGMA_MORNING_BC', 1.61049, -100, 100, 0, 'SIGMA_MORNING_BC')

ASC_BM = Beta('ASC_BM ', -0.319746, -100, 100, 0, 'ASC_BM ')

SIGMA_LUNCH_BM = Beta('SIGMA_LUNCH_BM', -2.50364, -100, 100, 0, 'SIGMA_LUNCH_BM')

SIGMA_MORNING_BM = Beta('SIGMA_MORNING_BM', 0.195084, -100, 100, 0, 'SIGMA_MORNING_BM')

BETA_DISTANCE_LUNCH_OTHER = Beta('BETA_DISTANCE_LUNCH_OTHER', 0.00019045, -100, 100, 0, 'BETA_DISTANCE_LUNCH_OTHER')

ASC_ELA = Beta('ASC_ELA ', -0.918538, -100, 100, 0, 'ASC_ELA ')

SIGMA_LUNCH_ELA = Beta('SIGMA_LUNCH_ELA', -0.788957, -100, 100, 0, 'SIGMA_LUNCH_ELA')

SIGMA_MORNING_ELA = Beta('SIGMA_MORNING_ELA', 1.13893, -100, 100, 0, 'SIGMA_MORNING_ELA')

ASC_INM = Beta('ASC_INM ', -1.80761, -100, 100, 0, 'ASC_INM ')

SIGMA_LUNCH_INM = Beta('SIGMA_LUNCH_INM ', -1.32819, -100, 100, 0, 'SIGMA_LUNCH_INM ')

SIGMA_MORNING_INM = Beta('SIGMA_MORNING_INM ', 0.725007, -100, 100, 0, 'SIGMA_MORNING_INM ')

ASC_MX = Beta('ASC_MX ', -1.78233, -100, 100, 0, 'ASC_MX ')

SIGMA_LUNCH_MX = Beta('SIGMA_LUNCH_MX ', 1.66472, -100, 100, 0, 'SIGMA_LUNCH_MX ')

SIGMA_MORNING_MX = Beta('SIGMA_MORNING_MX ', 1.16983, -100, 100, 0, 'SIGMA_MORNING_MX ')

ASC_PH = Beta('ASC_PH ', 0.704137, -100, 100, 0, 'ASC_PH ')

SIGMA_LUNCH_PH = Beta('SIGMA_LUNCH_PH ', -2.29818, -100, 100, 0, 'SIGMA_LUNCH_PH ')

SIGMA_MORNING_PH = Beta('SIGMA_MORNING_PH ', -0.352236, -100, 100, 0, 'SIGMA_MORNING_PH ')

ASC_ARC = Beta('ASC_ARC', -1.70265, -100, 100, 0, 'ASC_ARC')

SIGMA_LUNCH_ARC = Beta('SIGMA_LUNCH_ARC', 2.45895, -100, 100, 0, 'SIGMA_LUNCH_ARC')

SIGMA_MORNING_ARC = Beta('SIGMA_MORNING_ARC', -0.726105, -100, 100, 0, 'SIGMA_MORNING_ARC')

ASC_ATL = Beta('ASC_ATL ', -0.73102, -100, 100, 0, 'ASC_ATL ')

SIGMA_LUNCH_ATL = Beta('SIGMA_LUNCH_ATL ', -1.53615, -100, 100, 0, 'SIGMA_LUNCH_ATL ')

SIGMA_MORNING_ATL = Beta('SIGMA_MORNING_ATL ', 1.21443, -100, 100, 0, 'SIGMA_MORNING_ATL ')

ASC_COP = Beta('ASC_COP', 1.88168, -100, 100, 0, 'ASC_COP')

BETA_DISTANCE_LUNCH_REST = Beta('BETA_DISTANCE_LUNCH_REST', 0.00165943, -100, 100, 0, 'BETA_DISTANCE_LUNCH_REST')

SIGMA_LUNCH_COP = Beta('SIGMA_LUNCH_COP', 6.06116, -100, 100, 0, 'SIGMA_LUNCH_COP')

SIGMA_MORNING_COP = Beta('SIGMA_MORNING_COP', 0.377743, -100, 100, 0, 'SIGMA_MORNING_COP')

ASC_COR = Beta('ASC_COR ', -0.584922, -100, 100, 0, 'ASC_COR ')

SIGMA_LUNCH_COR = Beta('SIGMA_LUNCH_COR ', -0.855038, -100, 100, 0, 'SIGMA_LUNCH_COR ')

SIGMA_MORNING_COR = Beta('SIGMA_MORNING_COR ', -1.73675, -100, 100, 0, 'SIGMA_MORNING_COR ')

ASC_GIA = Beta('ASC_GIA ', 0.684708, -100, 100, 0, 'ASC_GIA ')

SIGMA_LUNCH_GIA = Beta('SIGMA_LUNCH_GIA ', 1.24407, -100, 100, 0, 'SIGMA_LUNCH_GIA ')

SIGMA_MORNING_GIA = Beta('SIGMA_MORNING_GIA ', -0.146586, -100, 100, 0, 'SIGMA_MORNING_GIA ')

ASC_PAR = Beta('ASC_PAR ', -1.59749, -100, 100, 0, 'ASC_PAR ')

SIGMA_LUNCH_PAR = Beta('SIGMA_LUNCH_PAR ', -1.18841, -100, 100, 0, 'SIGMA_LUNCH_PAR ')

SIGMA_MORNING_PAR = Beta('SIGMA_MORNING_PAR ', -1.43239, -100, 100, 0, 'SIGMA_MORNING_PAR ')

ASC_VIN = Beta('ASC_VIN', -4.96985, -100, 100, 0, 'ASC_VIN')

SIGMA_LUNCH_VIN = Beta('SIGMA_LUNCH_VIN', -1.37227, -100, 100, 0, 'SIGMA_LUNCH_VIN')

SIGMA_MORNING_VIN = Beta('SIGMA_MORNING_VIN', 0.395589, -100, 100, 0, 'SIGMA_MORNING_VIN')
...
ASC_ORN = Beta('ASC_ORN ', -1.23975, -100, 100, 0, 'ASC_ORN ')

SIGMA_LUNCH_ORN = Beta('SIGMA_LUNCH_ORN ', -0.258409, -100, 100, 0, 'SIGMA_LUNCH_ORN ')

SIGMA_MORNING_ORN = Beta('SIGMA_MORNING_ORN ', 0.236518, -100, 100, 0, 'SIGMA_MORNING_ORN ')

ASC_PIZ = Beta('ASC_PIZ ', -1.90761, -100, 100, 0, 'ASC_PIZ ')

SIGMA_LUNCH_PIZ = Beta('SIGMA_LUNCH_PIZ ', 1.28791, -100, 100, 0, 'SIGMA_LUNCH_PIZ ')

SIGMA_MORNING_PIZ = Beta('SIGMA_MORNING_PIZ ', -0.932131, -100, 100, 0, 'SIGMA_MORNING_PIZ ')

BETA_EVALUATION_FAST_FOOD = Beta('BETA_EVALUATION_FAST_FOOD', 2.57647, -100, 100, 0, 'BETA_EVALUATION_FAST_FOOD')

BETA_DISTANCE_LUNCH_FASTFOOD = Beta('BETA_DISTANCE_LUNCH_FASTFOOD', -0.00675563, -100, 100, 0, 'BETA_DISTANCE_LUNCH_FASTFOOD')

ASC_KEB = Beta('ASC_KEB ', -2.63927, -100, 100, 0, 'ASC_KEB ')

SIGMA_LUNCH_KEB = Beta('SIGMA_LUNCH_KEB ', -1.10523, -100, 100, 0, 'SIGMA_LUNCH_KEB ')

SIGMA_MORNING_KEB = Beta('SIGMA_MORNING_KEB ', -1.79, -100, 100, 0, 'SIGMA_MORNING_KEB ')

ASC_SAT = Beta('ASC_SAT ', -2.65101, -100, 100, 0, 'ASC_SAT ')

SIGMA_LUNCH_SAT = Beta('SIGMA_LUNCH_SAT ', -1.1953, -100, 100, 0, 'SIGMA_LUNCH_SAT ')

SIGMA_MORNING_SAT = Beta('SIGMA_MORNING_SAT ', -2.32436, -100, 100, 0, 'SIGMA_MORNING_SAT ')

ASC_HOD = Beta('ASC_HOD ', 2.75683, -100, 100, 0, 'ASC_HOD ')

SIGMA_LUNCH_HOD = Beta('SIGMA_LUNCH_HOD ', -0.910292, -100, 100, 0, 'SIGMA_LUNCH_HOD ')

SIGMA_MORNING_HOD = Beta('SIGMA_MORNING_HOD ', 0.289807, -100, 100, 0, 'SIGMA_MORNING_HOD ')

ASC_VAL = Beta('ASC_VAL ', 1.33736, -100, 100, 0, 'ASC_VAL ')

SIGMA_LUNCH_VAL = Beta('SIGMA_LUNCH_VAL ', -10.7765, -100, 100, 0, 'SIGMA_LUNCH_VAL ')

SIGMA_MORNING_VAL = Beta('SIGMA_MORNING_VAL ', 0.291806, -100, 100, 0, 'SIGMA_MORNING_VAL ')
...
P2 = mixedloglikelihood(prob2)
P3 = mixedloglikelihood(prob3)
P4 = mixedloglikelihood(prob4)
P5 = mixedloglikelihood(prob5)
P6 = mixedloglikelihood(prob6)
P7 = mixedloglikelihood(prob7)
P8 = mixedloglikelihood(prob8)
P9 = mixedloglikelihood(prob9)
P10 = mixedloglikelihood(prob10)
P11 = mixedloglikelihood(prob11)
P12 = mixedloglikelihood(prob12)
P13 = mixedloglikelihood(prob13)
P14 = mixedloglikelihood(prob14)
P15 = mixedloglikelihood(prob15)
P16 = mixedloglikelihood(prob16)
P17 = mixedloglikelihood(prob17)
P18 = mixedloglikelihood(prob18)
P19 = mixedloglikelihood(prob19)
P20 = mixedloglikelihood(prob20)
P21 = mixedloglikelihood(prob21)

logitelas1_students = OPEN_AV_1 * (1.0 - exp(P1)) * lunch_price_min_student_1 * BETA_PRICE_STUDENT
logitelas1_employees = OPEN_AV_1 * (1.0 - exp(P1)) * lunch_price_min_employee_1 * BETA_PRICE_EMPLOYEE
logitelas2_students = OPEN_AV_2 * (1.0 - exp(P2)) * lunch_price_min_student_2 * BETA_PRICE_STUDENT
logitelas2_employees = OPEN_AV_2 * (1.0 - exp(P2)) * lunch_price_min_employee_2 * BETA_PRICE_EMPLOYEE
logitelas3_students = OPEN_AV_3 * (1.0 - exp(P3)) * lunch_price_min_student_3 * BETA_PRICE_STUDENT
logitelas3_employees = OPEN_AV_3 * (1.0 - exp(P3)) * lunch_price_min_employee_3 * BETA_PRICE_EMPLOYEE
logitelas4_students = OPEN_AV_4 * (1.0 - exp(P4)) * lunch_price_min_student_4 * BETA_PRICE_STUDENT
logitelas4_employees = OPEN_AV_4 * (1.0 - exp(P4)) * lunch_price_min_employee_4 * BETA_PRICE_EMPLOYEE
logitelas5_students = OPEN_AV_5 * (1.0 - exp(P5)) * lunch_price_min_student_5 * BETA_PRICE_STUDENT
logitelas5_employees = OPEN_AV_5 * (1.0 - exp(P5)) * lunch_price_min_employee_5 * BETA_PRICE_EMPLOYEE
logitelas6_students = OPEN_AV_6 * (1.0 - exp(P6)) * lunch_price_min_student_6 * BETA_PRICE_STUDENT
logitelas6_employees = OPEN_AV_6 * (1.0 - exp(P6)) * lunch_price_min_employee_6 * BETA_PRICE_EMPLOYEE
logitelas7_students = OPEN_AV_7 * (1.0 - exp(P7)) * lunch_price_min_student_7 * BETA_PRICE_STUDENT
logitelas7_employees = OPEN_AV_7 * (1.0 - exp(P7)) * lunch_price_min_employee_7 * BETA_PRICE_EMPLOYEE
logitelas8_students = OPEN_AV_8 * (1.0 - exp(P8)) * lunch_price_min_student_8 * BETA_PRICE_STUDENT
logitelas8_employees = OPEN_AV_8 * (1.0 - exp(P8)) * lunch_price_min_employee_8 * BETA_PRICE_EMPLOYEE
logitelas9_students = OPEN_AV_9 * (1.0 - exp(P9)) * lunch_price_min_student_9 * BETA_PRICE_STUDENT
logitelas9_employees = OPEN_AV_9 * (1.0 - exp(P9)) * lunch_price_min_employee_9 * BETA_PRICE_EMPLOYEE
logitelas10_students = OPEN_AV_10 * (1.0 - exp(P10)) * lunch_price_min_student_10 * BETA_PRICE_STUDENT
logitelas10_employees = OPEN_AV_10 * (1.0 - exp(P10)) * lunch_price_min_employee_10 * BETA_PRICE_EMPLOYEE
logitelas11_students = OPEN_AV_11 * (1.0 - exp(P11)) * lunch_price_min_student_11 * BETA_PRICE_STUDENT
logitelas11_employees = OPEN_AV_11 * (1.0 - exp(P11)) * lunch_price_min_employee_11 * BETA_PRICE_EMPLOYEE
logitelas12_students = OPEN_AV_12 * (1.0 - exp(P12)) * lunch_price_min_student_12 * BETA_PRICE_STUDENT
logitelas12_employees = OPEN_AV_12 * (1.0 - exp(P12)) * lunch_price_min_employee_12 * BETA_PRICE_EMPLOYEE
logitelas13_students = OPEN_AV_13 * (1.0 - exp(P13)) * lunch_price_min_student_13 * BETA_PRICE_STUDENT
logitelas13_employees = OPEN_AV_13 * (1.0 - exp(P13)) * lunch_price_min_employee_13 * BETA_PRICE_EMPLOYEE
logitelas14_students = OPEN_AV_14 * (1.0 - exp(P6)) * lunch_price_min_student_14 * BETA_PRICE_STUDENT
logitelas14_employees = OPEN_AV_14 * (1.0 - exp(P14)) * lunch_price_min_employee_14 * BETA_PRICE_EMPLOYEE
logitelas15_students = OPEN_AV_15 * (1.0 - exp(P15)) * lunch_price_min_student_15 * BETA_PRICE_STUDENT
logitelas15_employees = OPEN_AV_15 * (1.0 - exp(P15)) * lunch_price_min_employee_15 * BETA_PRICE_EMPLOYEE
logitelas16_students = OPEN_AV_16 * (1.0 - exp(P16)) * lunch_price_min_student_16 * BETA_PRICE_STUDENT
logitelas16_employees = OPEN_AV_16 * (1.0 - exp(P16)) * lunch_price_min_employee_16 * BETA_PRICE_EMPLOYEE
logitelas17_students = OPEN_AV_17 * (1.0 - exp(P17)) * lunch_price_min_student_17 * BETA_PRICE_STUDENT
logitelas17_employees = OPEN_AV_17 * (1.0 - exp(P17)) * lunch_price_min_employee_17 * BETA_PRICE_EMPLOYEE
logitelas18_students = OPEN_AV_18 * (1.0 - exp(P18)) * lunch_price_min_student_18 * BETA_PRICE_STUDENT
logitelas18_employees = OPEN_AV_18 * (1.0 - exp(P18)) * lunch_price_min_employee_18 * BETA_PRICE_EMPLOYEE
logitelas19_students = OPEN_AV_19 * (1.0 - exp(P19)) * lunch_price_min_student_19 * BETA_PRICE_STUDENT
logitelas19_employees = OPEN_AV_19 * (1.0 - exp(P19)) * lunch_price_min_employee_19 * BETA_PRICE_EMPLOYEE
logitelas20_students = OPEN_AV_20 * (1.0 - exp(P20)) * lunch_price_min_student_20 * BETA_PRICE_STUDENT
logitelas20_employees = OPEN_AV_20 * (1.0 - exp(P20)) * lunch_price_min_employee_20 * BETA_PRICE_EMPLOYEE
logitelas21_students = OPEN_AV_21 * (1.0 - exp(P21)) * lunch_price_min_student_21 * BETA_PRICE_STUDENT
logitelas21_employees = OPEN_AV_21 * (1.0 - exp(P21)) * lunch_price_min_employee_21 * BETA_PRICE_EMPLOYEE
