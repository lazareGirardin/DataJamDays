#######################################
# Author: Loic Tinguely, Antonin Danalet, EPFL
#######################################
...
ASC_KLE = Beta('ASC_KLE', -2.91104, -100, 100, 0, 'ASC_KLE')
BETA_DISTANCE_LUNCH_CAF = Beta('BETA_DISTANCE_LUNCH_CAF', -0.00612427, -100, 100, 0, 'BETA_DISTANCE_LUNCH_CAF')
RHO_PREVIOUS_LUNCH_CHOICE = Beta('RHO_PREVIOUS_LUNCH_CHOICE', 1.78368, -100, 100, 0, 'RHO_PREVIOUS_LUNCH_CHOICE')
RHO_PREVIOUS_MORNING_CHOICE = Beta('RHO_PREVIOUS_MORNING_CHOICE', 3.06148, -100, 100, 0, 'RHO_PREVIOUS_MORNING_CHOICE')
BETA_DISTANCE_MORNING = Beta('BETA_DISTANCE_MORNING', -0.00448281, -100, 100, 0, 'BETA_DISTANCE_MORNING')
BETA_TAP_BEER_AFTER_LUNCH = Beta('BETA_TAP_BEER_AFTER_LUNCH', 0.538768, -100, 100, 0, 'BETA_TAP_BEER_AFTER_LUNCH')
BETA_DISTANCE_AFTERNOON = Beta('BETA_DISTANCE_AFTERNOON', -0.00107194, -100, 100, 0, 'BETA_DISTANCE_AFTERNOON')
BETA_EVALUATION_CAFET = Beta('BETA_EVALUATION_CAFET', 1.09778, -100, 100, 0, 'BETA_EVALUATION_CAFET')
BETA_NO_DISTANCE_AV = Beta('BETA_NO_DISTANCE_AV', -4.48314, -100, 100, 0, 'BETA_NO_DISTANCE_AV')
BETA_DINNER = Beta('BETA_DINNER', 1.03412, -100, 100, 0, 'BETA_DINNER')
BETA_PRICE_STUDENT = Beta('BETA_PRICE_STUDENT', -0.188516, -100, 100, 0, 'BETA_PRICE_STUDENT')
BETA_PRICE_EMPLOYEE = Beta('BETA_PRICE_EMPLOYEE', -0.102028, -100, 100, 0, 'BETA_PRICE_EMPLOYEE')
BETA_METEO_TERRACE = Beta('BETA_METEO_TERRACE', 0, -100, 100, 1, 'BETA_METEO_TERRACE')
BETA_CAPACITY_INSIDE = Beta('BETA_CAPACITY_INSIDE', 0.00748652, -100, 100, 0, 'BETA_CAPACITY_INSIDE')
ASC_BC = Beta('ASC_BC', 0.481469, -100, 100, 0, 'ASC_BC')
BETA_DISTANCE_LUNCH_SELF = Beta('BETA_DISTANCE_LUNCH_SELF', -0.00543447, -100, 100, 0, 'BETA_DISTANCE_LUNCH_SELF')
BETA_EVALUATION_SELF = Beta('BETA_EVALUATION_SELF', 1.08597, -100, 100, 0, 'BETA_EVALUATION_SELF')
ASC_BM = Beta('ASC_BM', 0.452717, -100, 100, 0, 'ASC_BM ')
BETA_DISTANCE_LUNCH_OTHER = Beta('BETA_DISTANCE_LUNCH_OTHER', -0.00100207, -100, 100, 0, 'BETA_DISTANCE_LUNCH_OTHER')
ASC_ELA = Beta('ASC_ELA', -0.578745, -100, 100, 0, 'ASC_ELA ')
ASC_INM = Beta('ASC_INM', -1.82479, -100, 100, 0, 'ASC_INM ')
ASC_MX = Beta('ASC_MX', -0.514217, -100, 100, 0, 'ASC_MX ')
ASC_PH = Beta('ASC_PH', 1.10778, -100, 100, 0, 'ASC_PH ')
ASC_ARC = Beta('ASC_ARC', -0.683618, -100, 100, 0, 'ASC_ARC')
ASC_ATL = Beta('ASC_ATL', -0.284999, -100, 100, 0, 'ASC_ATL ')
ASC_COP = Beta('ASC_COP', 2.66714, -100, 100, 0, 'ASC_COP')
BETA_DISTANCE_LUNCH_REST = Beta('BETA_DISTANCE_LUNCH_REST', -0.00126834, -100, 100, 0, 'BETA_DISTANCE_LUNCH_REST')
ASC_COR = Beta('ASC_COR', -0.259269, -100, 100, 0, 'ASC_COR ')
ASC_GIA = Beta('ASC_GIA', 0.397561, -100, 100, 0, 'ASC_GIA ')
ASC_PAR = Beta('ASC_PAR', -0.883177, -100, 100, 0, 'ASC_PAR ')
ASC_VIN = Beta('ASC_VIN', -3.81126, -100, 100, 0, 'ASC_VIN')
ASC_ESP = Beta('ASC_ESP', 0, -100, 100, 1, 'ASC_ESP ')
ASC_ORN = Beta('ASC_ORN', -0.641234, -100, 100, 0, 'ASC_ORN ')
ASC_PIZ = Beta('ASC_PIZ', -1.83719, -100, 100, 0, 'ASC_PIZ ')
BETA_EVALUATION_FAST_FOOD = Beta('BETA_EVALUATION_FAST_FOOD', 1.60132, -100, 100, 0, 'BETA_EVALUATION_FAST_FOOD')
BETA_DISTANCE_LUNCH_FASTFOOD = Beta('BETA_DISTANCE_LUNCH_FASTFOOD', -0.00881064, -100, 100, 0, 'BETA_DISTANCE_LUNCH_FASTFOOD')
ASC_KEB = Beta('ASC_KEB', -2.51063, -100, 100, 0, 'ASC_KEB ')
ASC_SAT = Beta('ASC_SAT', -1.41552, -100, 100, 0, 'ASC_SAT ')
ASC_HOD = Beta('ASC_HOD ', 0.954358, -100, 100, 0, 'ASC_HOD ')
ASC_VAL = Beta('ASC_VAL', 4.01875, -100, 100, 0, 'ASC_VAL ')
ALPHA_MOST_CHOSEN_LUNCH = Beta('ALPHA_MOST_CHOSEN_LUNCH', 0, -100, 100, 1)
ALPHA_MOST_CHOSEN_MORNING = Beta('ALPHA_MOST_CHOSEN_MORNING', 0, -100, 100, 1)
ALPHA_FREQUENCY_LUNCH = Beta('ALPHA_FREQUENCY_LUNCH', 0, -100, 100, 0)
ALPHA_FREQUENCY_MORNING = Beta('ALPHA_FREQUENCY_MORNING', 0, -100, 100, 0)
ALPHA_FIRST_LUNCH_CHOICE = Beta('ALPHA_FIRST_LUNCH_CHOICE', 0, -100, 100, 0)
ALPHA_FIRST_MORNING_CHOICE = Beta('ALPHA_FIRST_MORNING_CHOICE', 0, -100, 100, 0)
SIGMA_LUNCH_BC = Beta('SIGMA_LUNCH_BC', 0, -100, 100, 0)
SIGMA_LUNCH_BM = Beta('SIGMA_LUNCH_BM', 0, -100, 100, 0)
SIGMA_LUNCH_ELA = Beta('SIGMA_LUNCH_ELA', 0, -100, 100, 0)
SIGMA_LUNCH_MX = Beta('SIGMA_LUNCH_MX ', 0, -100, 100, 0)
SIGMA_LUNCH_PH = Beta('SIGMA_LUNCH_PH ', 0, -100, 100, 0)
SIGMA_LUNCH_ATL = Beta('SIGMA_LUNCH_ATL ', 0, -100, 100, 0)
SIGMA_LUNCH_COR = Beta('SIGMA_LUNCH_COR ', 0, -100, 100, 0)
SIGMA_LUNCH_GIA = Beta('SIGMA_LUNCH_GIA ', 0, -100, 100, 0)
SIGMA_LUNCH_PAR = Beta('SIGMA_LUNCH_PAR ', 0, -100, 100, 0)
SIGMA_LUNCH_ESP = Beta('SIGMA_LUNCH_ESP ', 0, -100, 100, 1)
SIGMA_LUNCH_ORN = Beta('SIGMA_LUNCH_ORN ', 0, -100, 100, 0)
SIGMA_LUNCH_PIZ = Beta('SIGMA_LUNCH_PIZ ', 0, -100, 100, 0)
SIGMA_LUNCH_KEB = Beta('SIGMA_LUNCH_KEB ', 0, -100, 100, 0)
SIGMA_LUNCH_SAT = Beta('SIGMA_LUNCH_SAT ', 0, -100, 100, 0)
SIGMA_LUNCH_HOD = Beta('SIGMA_LUNCH_HOD ', 0, -100, 100, 0)
SIGMA_LUNCH_VAL = Beta('SIGMA_LUNCH_VAL ', 0, -100, 100, 0)
SIGMA_LUNCH_INM = Beta('SIGMA_LUNCH_INM ', 0, -100, 100, 0)
SIGMA_LUNCH_VIN = Beta('SIGMA_LUNCH_VIN', 0, -100, 100, 0)
SIGMA_LUNCH_COP = Beta('SIGMA_LUNCH_COP', 0, -100, 100, 0)
SIGMA_LUNCH_KLE = Beta('SIGMA_LUNCH_KLE', 0, -100, 100, 0)
SIGMA_LUNCH_ARC = Beta('SIGMA_LUNCH_ARC', 0, -100, 100, 0)
SIGMA_MORNING_BC = Beta('SIGMA_MORNING_BC', 0, -100, 100, 0)
SIGMA_MORNING_BM = Beta('SIGMA_MORNING_BM', 0, -100, 100, 0)
SIGMA_MORNING_ELA = Beta('SIGMA_MORNING_ELA', 0, -100, 100, 0)
SIGMA_MORNING_MX = Beta('SIGMA_MORNING_MX ', 0, -100, 100, 0)
SIGMA_MORNING_PH = Beta('SIGMA_MORNING_PH ', 0, -100, 100, 0)
SIGMA_MORNING_ATL = Beta('SIGMA_MORNING_ATL ', 0, -100, 100, 0)
SIGMA_MORNING_COR = Beta('SIGMA_MORNING_COR ', 0, -100, 100, 0)
SIGMA_MORNING_GIA = Beta('SIGMA_MORNING_GIA ', 0, -100, 100, 0)
SIGMA_MORNING_PAR = Beta('SIGMA_MORNING_PAR ', 0, -100, 100, 0)
SIGMA_MORNING_ESP = Beta('SIGMA_MORNING_ESP ', 0, -100, 100, 1)
SIGMA_MORNING_ORN = Beta('SIGMA_MORNING_ORN ', 0, -100, 100, 0)
SIGMA_MORNING_PIZ = Beta('SIGMA_MORNING_PIZ ', 0, -100, 100, 0)
SIGMA_MORNING_KEB = Beta('SIGMA_MORNING_KEB ', 0, -100, 100, 0)
SIGMA_MORNING_SAT = Beta('SIGMA_MORNING_SAT ', 0, -100, 100, 0)
SIGMA_MORNING_HOD = Beta('SIGMA_MORNING_HOD ', 0, -100, 100, 0)
SIGMA_MORNING_VAL = Beta('SIGMA_MORNING_VAL ', 0, -100, 100, 0)
SIGMA_MORNING_INM = Beta('SIGMA_MORNING_INM ', 0, -100, 100, 0)
SIGMA_MORNING_VIN = Beta('SIGMA_MORNING_VIN', 0, -100, 100, 0)
SIGMA_MORNING_COP = Beta('SIGMA_MORNING_COP', 0, -100, 100, 0)
SIGMA_MORNING_KLE = Beta('SIGMA_MORNING_KLE', 0, -100, 100, 0)
SIGMA_MORNING_ARC = Beta('SIGMA_MORNING_ARC', 0, -100, 100, 0)
...
V3 = ASC_BM \
    ...
    + lunch * EC_SIGMA_LUNCH_BM + morning * EC_SIGMA_MORNING_BM \
...
# Catering locations are available when open
av = {1: OPEN_AV_1,
      2: OPEN_AV_2,
      3: OPEN_AV_3,
      4: OPEN_AV_4,
