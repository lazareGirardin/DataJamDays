...
ASC_KLE = Beta('ASC_KLE', -3.34026, -100, 100, 0, 'ASC_KLE')

BETA_DISTANCE_LUNCH_CAF = Beta('BETA_DISTANCE_LUNCH_CAF', -0.00419332, -100, 100, 0, 'BETA_DISTANCE_LUNCH_CAF')

ALPHA_FIRST_LUNCH_CHOICE = Beta('ALPHA_FIRST_LUNCH_CHOICE', 1.05376, -100, 100, 0, 'ALPHA_FIRST_LUNCH_CHOICE')

ALPHA_FIRST_MORNING_CHOICE = Beta('ALPHA_FIRST_MORNING_CHOICE', 1.18302, -100, 100, 0, 'ALPHA_FIRST_MORNING_CHOICE')
...
RHO_PREVIOUS_MORNING_CHOICE = Beta('RHO_PREVIOUS_MORNING_CHOICE', 0.450259, -100, 100, 0, 'RHO_PREVIOUS_MORNING_CHOICE')

RHO_PREVIOUS_LUNCH_CHOICE = Beta('RHO_PREVIOUS_LUNCH_CHOICE', 0.444104, -100, 100, 0, 'RHO_PREVIOUS_LUNCH_CHOICE')

BETA_DISTANCE_MORNING = Beta('BETA_DISTANCE_MORNING', -0.00380687, -100, 100, 0, 'BETA_DISTANCE_MORNING')

BETA_TAP_BEER_AFTER_LUNCH = Beta('BETA_TAP_BEER_AFTER_LUNCH', 0.915039, -100, 100, 0, 'BETA_TAP_BEER_AFTER_LUNCH')

BETA_DISTANCE_AFTERNOON = Beta('BETA_DISTANCE_AFTERNOON', -0.000830375, -100, 100, 0, 'BETA_DISTANCE_AFTERNOON')

BETA_EVALUATION_CAFET = Beta('BETA_EVALUATION_CAFET', 1.85716, -100, 100, 0, 'BETA_EVALUATION_CAFET')

BETA_NO_DISTANCE_AV = Beta('BETA_NO_DISTANCE_AV', -3.53602, -100, 100, 0, 'BETA_NO_DISTANCE_AV')

BETA_DINNER = Beta('BETA_DINNER', 0.630623, -100, 100, 0, 'BETA_DINNER')

BETA_PRICE_STUDENT = Beta('BETA_PRICE_STUDENT', -0.340066, -100, 100, 0, 'BETA_PRICE_STUDENT')

BETA_PRICE_EMPLOYEE = Beta('BETA_PRICE_EMPLOYEE', -0.203227, -100, 100, 0, 'BETA_PRICE_EMPLOYEE')

BETA_METEO_TERRACE = Beta('BETA_METEO_TERRACE', 0, -100, 100, 1, 'BETA_METEO_TERRACE')

BETA_CAPACITY_INSIDE = Beta('BETA_CAPACITY_INSIDE', 0.0122322, -100, 100, 0, 'BETA_CAPACITY_INSIDE')

SIGMA_LUNCH_KLE = Beta('SIGMA_LUNCH_KLE', -2.1543, -100, 100, 0, 'SIGMA_LUNCH_KLE')

SIGMA_MORNING_KLE = Beta('SIGMA_MORNING_KLE', -1.08926, -100, 100, 0, 'SIGMA_MORNING_KLE')

ALPHA_FREQUENCY_LUNCH = Beta('ALPHA_FREQUENCY_LUNCH', 0.356484, -100, 100, 0, 'ALPHA_FREQUENCY_LUNCH')

ALPHA_FREQUENCY_MORNING = Beta('ALPHA_FREQUENCY_MORNING', 0.443246, -100, 100, 0, 'ALPHA_FREQUENCY_MORNING')

ASC_BC = Beta('ASC_BC', -0.631436, -100, 100, 0, 'ASC_BC')

BETA_DISTANCE_LUNCH_SELF = Beta('BETA_DISTANCE_LUNCH_SELF', -0.00399204, -100, 100, 0, 'BETA_DISTANCE_LUNCH_SELF')

BETA_EVALUATION_SELF = Beta('BETA_EVALUATION_SELF', 1.9524, -100, 100, 0, 'BETA_EVALUATION_SELF')

SIGMA_LUNCH_BC = Beta('SIGMA_LUNCH_BC', -2.34877, -100, 100, 0, 'SIGMA_LUNCH_BC')

SIGMA_MORNING_BC = Beta('SIGMA_MORNING_BC', -2.03881, -100, 100, 0, 'SIGMA_MORNING_BC')

ASC_BM = Beta('ASC_BM ', -0.0940139, -100, 100, 0, 'ASC_BM ')

SIGMA_LUNCH_BM = Beta('SIGMA_LUNCH_BM', -2.77797, -100, 100, 0, 'SIGMA_LUNCH_BM')

SIGMA_MORNING_BM = Beta('SIGMA_MORNING_BM', -0.325733, -100, 100, 0, 'SIGMA_MORNING_BM')

BETA_DISTANCE_LUNCH_OTHER = Beta('BETA_DISTANCE_LUNCH_OTHER', -0.000357552, -100, 100, 0, 'BETA_DISTANCE_LUNCH_OTHER')

ASC_ELA = Beta('ASC_ELA ', -0.782177, -100, 100, 0, 'ASC_ELA ')

SIGMA_LUNCH_ELA = Beta('SIGMA_LUNCH_ELA', -0.977829, -100, 100, 0, 'SIGMA_LUNCH_ELA')

SIGMA_MORNING_ELA = Beta('SIGMA_MORNING_ELA', -0.809092, -100, 100, 0, 'SIGMA_MORNING_ELA')

ASC_INM = Beta('ASC_INM ', -1.90399, -100, 100, 0, 'ASC_INM ')

SIGMA_LUNCH_INM = Beta('SIGMA_LUNCH_INM ', 1.69622, -100, 100, 0, 'SIGMA_LUNCH_INM ')

SIGMA_MORNING_INM = Beta('SIGMA_MORNING_INM ', 1.48873, -100, 100, 0, 'SIGMA_MORNING_INM ')

ASC_MX = Beta('ASC_MX ', -1.68804, -100, 100, 0, 'ASC_MX ')

SIGMA_LUNCH_MX = Beta('SIGMA_LUNCH_MX ', 2.28233, -100, 100, 0, 'SIGMA_LUNCH_MX ')

SIGMA_MORNING_MX = Beta('SIGMA_MORNING_MX ', -0.587631, -100, 100, 0, 'SIGMA_MORNING_MX ')

ASC_PH = Beta('ASC_PH ', 0.424589, -100, 100, 0, 'ASC_PH ')

SIGMA_LUNCH_PH = Beta('SIGMA_LUNCH_PH ', 3.80429, -100, 100, 0, 'SIGMA_LUNCH_PH ')

SIGMA_MORNING_PH = Beta('SIGMA_MORNING_PH ', 0.27193, -100, 100, 0, 'SIGMA_MORNING_PH ')

ASC_ARC = Beta('ASC_ARC', -2.48821, -100, 100, 0, 'ASC_ARC')

SIGMA_LUNCH_ARC = Beta('SIGMA_LUNCH_ARC', 2.74285, -100, 100, 0, 'SIGMA_LUNCH_ARC')

SIGMA_MORNING_ARC = Beta('SIGMA_MORNING_ARC', 1.42445, -100, 100, 0, 'SIGMA_MORNING_ARC')

ASC_ATL = Beta('ASC_ATL ', -0.996098, -100, 100, 0, 'ASC_ATL ')

SIGMA_LUNCH_ATL = Beta('SIGMA_LUNCH_ATL ', -1.60194, -100, 100, 0, 'SIGMA_LUNCH_ATL ')

SIGMA_MORNING_ATL = Beta('SIGMA_MORNING_ATL ', -1.10988, -100, 100, 0, 'SIGMA_MORNING_ATL ')

ASC_COP = Beta('ASC_COP', 5.26834, -100, 100, 0, 'ASC_COP')

BETA_DISTANCE_LUNCH_REST = Beta('BETA_DISTANCE_LUNCH_REST', -0.000705033, -100, 100, 0, 'BETA_DISTANCE_LUNCH_REST')

SIGMA_LUNCH_COP = Beta('SIGMA_LUNCH_COP', 3.68908, -100, 100, 0, 'SIGMA_LUNCH_COP')

SIGMA_MORNING_COP = Beta('SIGMA_MORNING_COP', -5.53711, -100, 100, 0, 'SIGMA_MORNING_COP')

ASC_COR = Beta('ASC_COR ', -0.472547, -100, 100, 0, 'ASC_COR ')

SIGMA_LUNCH_COR = Beta('SIGMA_LUNCH_COR ', 0.749589, -100, 100, 0, 'SIGMA_LUNCH_COR ')

SIGMA_MORNING_COR = Beta('SIGMA_MORNING_COR ', -2.20967, -100, 100, 0, 'SIGMA_MORNING_COR ')

ASC_GIA = Beta('ASC_GIA ', 0.935669, -100, 100, 0, 'ASC_GIA ')

SIGMA_LUNCH_GIA = Beta('SIGMA_LUNCH_GIA ', -0.949834, -100, 100, 0, 'SIGMA_LUNCH_GIA ')

SIGMA_MORNING_GIA = Beta('SIGMA_MORNING_GIA ', -0.378673, -100, 100, 0, 'SIGMA_MORNING_GIA ')

ASC_PAR = Beta('ASC_PAR ', -1.82619, -100, 100, 0, 'ASC_PAR ')

SIGMA_LUNCH_PAR = Beta('SIGMA_LUNCH_PAR ', -1.27899, -100, 100, 0, 'SIGMA_LUNCH_PAR ')

SIGMA_MORNING_PAR = Beta('SIGMA_MORNING_PAR ', -2.75515, -100, 100, 0, 'SIGMA_MORNING_PAR ')

ASC_VIN = Beta('ASC_VIN', -5.1502, -100, 100, 0, 'ASC_VIN')

SIGMA_LUNCH_VIN = Beta('SIGMA_LUNCH_VIN', -1.29458, -100, 100, 0, 'SIGMA_LUNCH_VIN')

SIGMA_MORNING_VIN = Beta('SIGMA_MORNING_VIN', -0.263576, -100, 100, 0, 'SIGMA_MORNING_VIN')
...
ASC_ORN = Beta('ASC_ORN ', -1.28027, -100, 100, 0, 'ASC_ORN ')

SIGMA_LUNCH_ORN = Beta('SIGMA_LUNCH_ORN ', 0.478922, -100, 100, 0, 'SIGMA_LUNCH_ORN ')

SIGMA_MORNING_ORN = Beta('SIGMA_MORNING_ORN ', -0.235436, -100, 100, 0, 'SIGMA_MORNING_ORN ')

ASC_PIZ = Beta('ASC_PIZ ', -2.14113, -100, 100, 0, 'ASC_PIZ ')

SIGMA_LUNCH_PIZ = Beta('SIGMA_LUNCH_PIZ ', -1.57621, -100, 100, 0, 'SIGMA_LUNCH_PIZ ')

SIGMA_MORNING_PIZ = Beta('SIGMA_MORNING_PIZ ', 1.96879, -100, 100, 0, 'SIGMA_MORNING_PIZ ')

BETA_EVALUATION_FAST_FOOD = Beta('BETA_EVALUATION_FAST_FOOD', 2.50987, -100, 100, 0, 'BETA_EVALUATION_FAST_FOOD')

BETA_DISTANCE_LUNCH_FASTFOOD = Beta('BETA_DISTANCE_LUNCH_FASTFOOD', -0.00642152, -100, 100, 0, 'BETA_DISTANCE_LUNCH_FASTFOOD')

ASC_KEB = Beta('ASC_KEB ', -2.22942, -100, 100, 0, 'ASC_KEB ')

SIGMA_LUNCH_KEB = Beta('SIGMA_LUNCH_KEB ', 0.890644, -100, 100, 0, 'SIGMA_LUNCH_KEB ')

SIGMA_MORNING_KEB = Beta('SIGMA_MORNING_KEB ', 1.32413, -100, 100, 0, 'SIGMA_MORNING_KEB ')

ASC_SAT = Beta('ASC_SAT ', -2.56417, -100, 100, 0, 'ASC_SAT ')

SIGMA_LUNCH_SAT = Beta('SIGMA_LUNCH_SAT ', 1.35451, -100, 100, 0, 'SIGMA_LUNCH_SAT ')

SIGMA_MORNING_SAT = Beta('SIGMA_MORNING_SAT ', 2.75251, -100, 100, 0, 'SIGMA_MORNING_SAT ')

ASC_HOD = Beta('ASC_HOD ', 2.23741, -100, 100, 0, 'ASC_HOD ')

SIGMA_LUNCH_HOD = Beta('SIGMA_LUNCH_HOD ', -0.24877, -100, 100, 0, 'SIGMA_LUNCH_HOD ')

SIGMA_MORNING_HOD = Beta('SIGMA_MORNING_HOD ', 1.62825, -100, 100, 0, 'SIGMA_MORNING_HOD ')

ASC_VAL = Beta('ASC_VAL ', 1.0092, -100, 100, 0, 'ASC_VAL ')

SIGMA_LUNCH_VAL = Beta('SIGMA_LUNCH_VAL ', 5.65897, -100, 100, 0, 'SIGMA_LUNCH_VAL ')

SIGMA_MORNING_VAL = Beta('SIGMA_MORNING_VAL ', -1.15366, -100, 100, 0, 'SIGMA_MORNING_VAL ')
