...
ASC_KLE = Beta('ASC_KLE', -2.46895, -100, 100, 0, 'ASC_KLE')

BETA_DISTANCE_LUNCH_CAF = Beta('BETA_DISTANCE_LUNCH_CAF', -0.00618913, -100, 100, 0, 'BETA_DISTANCE_LUNCH_CAF')

RHO_PREVIOUS_LUNCH_CHOICE = Beta('RHO_PREVIOUS_LUNCH_CHOICE', 1.70253, -100, 100, 0, 'RHO_PREVIOUS_LUNCH_CHOICE')

RHO_PREVIOUS_MORNING_CHOICE = Beta('RHO_PREVIOUS_MORNING_CHOICE', 3.05587, -100, 100, 0, 'RHO_PREVIOUS_MORNING_CHOICE')

BETA_DISTANCE_MORNING = Beta('BETA_DISTANCE_MORNING', -0.00441076, -100, 100, 0, 'BETA_DISTANCE_MORNING')

BETA_TAP_BEER_AFTER_LUNCH = Beta('BETA_TAP_BEER_AFTER_LUNCH', 0.312725, -100, 100, 0, 'BETA_TAP_BEER_AFTER_LUNCH')

BETA_DISTANCE_AFTERNOON = Beta('BETA_DISTANCE_AFTERNOON', -0.001131, -100, 100, 0, 'BETA_DISTANCE_AFTERNOON')

BETA_EVALUATION_CAFET = Beta('BETA_EVALUATION_CAFET', 1.09239, -100, 100, 0, 'BETA_EVALUATION_CAFET')

BETA_NO_DISTANCE_AV = Beta('BETA_NO_DISTANCE_AV', -4.28619, -100, 100, 0, 'BETA_NO_DISTANCE_AV')

BETA_DINNER = Beta('BETA_DINNER', 0.712038, -100, 100, 0, 'BETA_DINNER')

BETA_PRICE_STUDENT = Beta('BETA_PRICE_STUDENT', -0.183088, -100, 100, 0, 'BETA_PRICE_STUDENT')

BETA_PRICE_EMPLOYEE = Beta('BETA_PRICE_EMPLOYEE', -0.0891282, -100, 100, 0, 'BETA_PRICE_EMPLOYEE')

BETA_METEO_TERRACE = Beta('BETA_METEO_TERRACE', 0, -100, 100, 1, 'BETA_METEO_TERRACE')

BETA_CAPACITY_INSIDE = Beta('BETA_CAPACITY_INSIDE', 0.00633975, -100, 100, 0, 'BETA_CAPACITY_INSIDE')

ASC_BC = Beta('ASC_BC', 0.159644, -100, 100, 0, 'ASC_BC')

BETA_DISTANCE_LUNCH_SELF = Beta('BETA_DISTANCE_LUNCH_SELF', -0.00559037, -100, 100, 0, 'BETA_DISTANCE_LUNCH_SELF')

BETA_EVALUATION_SELF = Beta('BETA_EVALUATION_SELF', 1.15583, -100, 100, 0, 'BETA_EVALUATION_SELF')

ASC_BM = Beta('ASC_BM ', 0.512706, -100, 100, 0, 'ASC_BM ')

BETA_DISTANCE_LUNCH_OTHER = Beta('BETA_DISTANCE_LUNCH_OTHER', -0.00128633, -100, 100, 0, 'BETA_DISTANCE_LUNCH_OTHER')

ASC_ELA = Beta('ASC_ELA ', -0.518828, -100, 100, 0, 'ASC_ELA ')

ASC_INM = Beta('ASC_INM ', -1.57094, -100, 100, 0, 'ASC_INM ')

ASC_MX = Beta('ASC_MX ', -0.329755, -100, 100, 0, 'ASC_MX ')

ASC_PH = Beta('ASC_PH ', 1.2556, -100, 100, 0, 'ASC_PH ')

ASC_ARC = Beta('ASC_ARC', -0.687651, -100, 100, 0, 'ASC_ARC')

ASC_ATL = Beta('ASC_ATL ', -0.399731, -100, 100, 0, 'ASC_ATL ')

ASC_COP = Beta('ASC_COP', 3.00176, -100, 100, 0, 'ASC_COP')

BETA_DISTANCE_LUNCH_REST = Beta('BETA_DISTANCE_LUNCH_REST', -0.00250811, -100, 100, 0, 'BETA_DISTANCE_LUNCH_REST')

ASC_COR = Beta('ASC_COR ', -0.166902, -100, 100, 0, 'ASC_COR ')

ASC_GIA = Beta('ASC_GIA ', 0.503329, -100, 100, 0, 'ASC_GIA ')

ASC_PAR = Beta('ASC_PAR ', -0.768577, -100, 100, 0, 'ASC_PAR ')

ASC_VIN = Beta('ASC_VIN', -4.26652, -100, 100, 0, 'ASC_VIN')

ASC_ESP = Beta('ASC_ESP ', 0, -100, 100, 1, 'ASC_ESP ')

ASC_ORN = Beta('ASC_ORN ', -0.59546, -100, 100, 0, 'ASC_ORN ')

ASC_PIZ = Beta('ASC_PIZ ', -1.53692, -100, 100, 0, 'ASC_PIZ ')

BETA_EVALUATION_FAST_FOOD = Beta('BETA_EVALUATION_FAST_FOOD', 1.56434, -100, 100, 0, 'BETA_EVALUATION_FAST_FOOD')

BETA_DISTANCE_LUNCH_FASTFOOD = Beta('BETA_DISTANCE_LUNCH_FASTFOOD', -0.0088509, -100, 100, 0, 'BETA_DISTANCE_LUNCH_FASTFOOD')

ASC_KEB = Beta('ASC_KEB ', -2.24256, -100, 100, 0, 'ASC_KEB ')

ASC_SAT = Beta('ASC_SAT ', -1.08366, -100, 100, 0, 'ASC_SAT ')

ASC_HOD = Beta('ASC_HOD ', 0.840803, -100, 100, 0, 'ASC_HOD ')

ASC_VAL = Beta('ASC_VAL ', 4.08504, -100, 100, 0, 'ASC_VAL ')
