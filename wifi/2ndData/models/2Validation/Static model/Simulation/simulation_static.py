...
ASC_KLE = Beta('ASC_KLE', -2.85184, -100, 100, 0, 'ASC_KLE')

BETA_DISTANCE_LUNCH_CAF = Beta('BETA_DISTANCE_LUNCH_CAF', -0.00701761, -100, 100, 0, 'BETA_DISTANCE_LUNCH_CAF')

BETA_DISTANCE_MORNING = Beta('BETA_DISTANCE_MORNING', -0.00555018, -100, 100, 0, 'BETA_DISTANCE_MORNING')

BETA_TAP_BEER_AFTER_LUNCH = Beta('BETA_TAP_BEER_AFTER_LUNCH', 0.518306, -100, 100, 0, 'BETA_TAP_BEER_AFTER_LUNCH')

BETA_DISTANCE_AFTERNOON = Beta('BETA_DISTANCE_AFTERNOON', -0.000491533, -100, 100, 0, 'BETA_DISTANCE_AFTERNOON')

BETA_EVALUATION_CAFET = Beta('BETA_EVALUATION_CAFET', 1.18723, -100, 100, 0, 'BETA_EVALUATION_CAFET')

BETA_NO_DISTANCE_AV = Beta('BETA_NO_DISTANCE_AV', -4.89931, -100, 100, 0, 'BETA_NO_DISTANCE_AV')

BETA_DINNER = Beta('BETA_DINNER', 0.720212, -100, 100, 0, 'BETA_DINNER')

BETA_PRICE_STUDENT = Beta('BETA_PRICE_STUDENT', -0.251327, -100, 100, 0, 'BETA_PRICE_STUDENT')

BETA_PRICE_EMPLOYEE = Beta('BETA_PRICE_EMPLOYEE', -0.124831, -100, 100, 0, 'BETA_PRICE_EMPLOYEE')

BETA_METEO_TERRACE = Beta('BETA_METEO_TERRACE', 0, -100, 100, 1, 'BETA_METEO_TERRACE')

BETA_CAPACITY_INSIDE = Beta('BETA_CAPACITY_INSIDE', 0.00523933, -100, 100, 0, 'BETA_CAPACITY_INSIDE')

ASC_BC = Beta('ASC_BC', 0.0397548, -100, 100, 0, 'ASC_BC')

BETA_DISTANCE_LUNCH_SELF = Beta('BETA_DISTANCE_LUNCH_SELF', -0.00663142, -100, 100, 0, 'BETA_DISTANCE_LUNCH_SELF')

BETA_EVALUATION_SELF = Beta('BETA_EVALUATION_SELF', 1.29914, -100, 100, 0, 'BETA_EVALUATION_SELF')

ASC_BM = Beta('ASC_BM', 0.504913, -100, 100, 0, 'ASC_BM')

BETA_DISTANCE_LUNCH_OTHER = Beta('BETA_DISTANCE_LUNCH_OTHER', -0.00233571, -100, 100, 0, 'BETA_DISTANCE_LUNCH_OTHER')

ASC_ELA = Beta('ASC_ELA', -0.787651, -100, 100, 0, 'ASC_ELA ')

ASC_INM = Beta('ASC_INM ', -1.99723, -100, 100, 0, 'ASC_INM ')

ASC_MX = Beta('ASC_MX ', -0.300057, -100, 100, 0, 'ASC_MX ')

ASC_PH = Beta('ASC_PH ', 1.41306, -100, 100, 0, 'ASC_PH ')

ASC_ARC = Beta('ASC_ARC', -0.774754, -100, 100, 0, 'ASC_ARC')

ASC_ATL = Beta('ASC_ATL ', -0.273688, -100, 100, 0, 'ASC_ATL ')

ASC_COP = Beta('ASC_COP', 3.11655, -100, 100, 0, 'ASC_COP')

BETA_DISTANCE_LUNCH_REST = Beta('BETA_DISTANCE_LUNCH_REST', -0.00235841, -100, 100, 0, 'BETA_DISTANCE_LUNCH_REST')

ASC_COR = Beta('ASC_COR ', -0.167282, -100, 100, 0, 'ASC_COR ')

ASC_GIA = Beta('ASC_GIA ', 0.41775, -100, 100, 0, 'ASC_GIA ')

ASC_PAR = Beta('ASC_PAR ', -0.690426, -100, 100, 0, 'ASC_PAR ')

ASC_VIN = Beta('ASC_VIN', -4.55992, -100, 100, 0, 'ASC_VIN')

ASC_ESP = Beta('ASC_ESP ', 0, -100, 100, 1, 'ASC_ESP ')

ASC_ORN = Beta('ASC_ORN ', -0.605396, -100, 100, 0, 'ASC_ORN ')

ASC_PIZ = Beta('ASC_PIZ ', -1.69094, -100, 100, 0, 'ASC_PIZ ')

BETA_EVALUATION_FAST_FOOD = Beta('BETA_EVALUATION_FAST_FOOD', 1.65863, -100, 100, 0, 'BETA_EVALUATION_FAST_FOOD')

BETA_DISTANCE_LUNCH_FASTFOOD = Beta('BETA_DISTANCE_LUNCH_FASTFOOD', -0.00964766, -100, 100, 0, 'BETA_DISTANCE_LUNCH_FASTFOOD')

ASC_KEB = Beta('ASC_KEB ', -2.4949, -100, 100, 0, 'ASC_KEB ')

ASC_SAT = Beta('ASC_SAT ', -1.27796, -100, 100, 0, 'ASC_SAT ')

ASC_HOD = Beta('ASC_HOD ', 0.860284, -100, 100, 0, 'ASC_HOD ')

ASC_VAL = Beta('ASC_VAL ', 4.41213, -100, 100, 0, 'ASC_VAL ')
