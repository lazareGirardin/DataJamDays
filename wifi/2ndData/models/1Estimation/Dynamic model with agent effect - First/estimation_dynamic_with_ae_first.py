...
ALPHA_FREQUENCY_LUNCH = Beta('ALPHA_FREQUENCY_LUNCH', 0, -100, 100, 1)
ALPHA_FREQUENCY_MORNING = Beta('ALPHA_FREQUENCY_MORNING', 0, -100, 100, 1)
...
# Normally distributed random variable (lunch break)
...
# Normally distributed random variable (in the morning)
...
V6 = ASC_MX \
    ...
    + lunch * EC_SIGMA_LUNCH_MX + morning * EC_SIGMA_MORNING_MX \
...
# Activity episodes longer than 5 minutes are excluded
exclude = DURATION < 5
