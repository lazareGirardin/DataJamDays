...
# Associate utility functions with the numbering of alternatives in the data file
V = {1: V1,
     2: V2,
     3: V3,
     4: V4,
...
# A catering location is available if it is open.
av = {1: OPEN_AV_1,
      2: OPEN_AV_2,
      3: OPEN_AV_3,
      4: OPEN_AV_4,
...
# The model excludes all activity episodes with a duration shorter than 5 minutes.
exclude = DURATION < 5
